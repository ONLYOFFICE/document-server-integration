...
public class TrackManager {
    ...
    public static void processSave(JSONObject body, String fileName, String userAddress) throws Exception {
        ...
        if (!curExt.equals(downloadExt)) {
            try {
                String newFileUri = ServiceConverter.GetConvertedUri(downloadUri, downloadExt, curExt, ServiceConverter.GenerateRevisionId(downloadUri), false);  // convert file and get url to a new file
    ...
    public static void processForceSave(JSONObject body, String fileName, String userAddress) throws Exception {
        ...
        if (isSubmitForm) {
            ...
            DocumentManager.CreateMeta(newFileName, user, "Filling Form", userAddress);  // create meta data for forcesaved file
        }
    }
