  ...
  class << self
    ...
    def create_meta(file_name, uid, uname, user_address)
      ...
      json = {
        ...
        :uid => uid ? uid : "uid-0",  # if the parameters are undefined, use the default ones
